    ...
    call_mail();
		...
		<div class="row">
				<form data-parsley-validate action="<?php echo esc_url( $_SERVER['REQUEST_URI'] ); ?>" method="post">
                    	...
                    	<div class="col-sm-3"><input type="tel" name="cf-tel" value="<?php if(isset($_POST['cf-tel']))  echo $_POST['cf-tel'];?>"  size="40" placeholder="Телефон" data-parsley-trigger="change" data-parsley-pattern="^[\d\+\-\.\(\)\/\s]*$"></div>
